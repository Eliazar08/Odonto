    ...
    public class PatientController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Patient != null ? 
                          ...
                          Problem("Entity set 'PatientContext.Patient'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("MedicalHistory,Name,Lastname,Email,Age,CellPhone,Id")] Patient patient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MedicalHistory,Name,Lastname,Email,Age,CellPhone,Id")] Patient patient)
        {
            if (id != patient.Id)
            {
                return NotFound();
